...
def dbsetup(name, base):
    ...
    return session()
class Credentials(CredBase):
    __tablename__ = "cred"
    username, password = Column(String(128), primary_key=True), Column(String(256))
    salt, token = Column(String(256)),  Column(String(128), nullable=True)
def cred_db():
